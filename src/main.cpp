...
int main(int argc, char *argv[])
{
    ...
    else if (mode == "convergence_lbgk") lb::runner::convergence_test(17, 128, 0.25, 20, 0.05, 3e4, lb::CollisionType::LBGK);
    else if (mode == "convergence_kbc") lb::runner::convergence_test(17, 128, 0.25, 20, 0.05, 3e4, lb::CollisionType::KBC);
