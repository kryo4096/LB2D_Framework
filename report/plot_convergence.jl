...
function plot_error_csv(output, plots...)
    ...
    ax = Axis(fig[1,1], xscale=log2, yscale=log10, xlabel="L", ylabel=L"error", aspect=1, title= L"$L^{\infty}$-norm of error")
...
plot_error_csv("report/plots/KBC_1e4.png",  ("report/data/KBC_1e4_t10.csv", L"Re=10^4,t=10"))
